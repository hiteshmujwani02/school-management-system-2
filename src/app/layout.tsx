...
export const metadata: Metadata = {
  title: "Best School App & Web Development Company - Vigorous IT",
  description: "Using the latest web frameworks, Vigorous IT offers web app development services that turn ideas into profitable business solutions.",
};
