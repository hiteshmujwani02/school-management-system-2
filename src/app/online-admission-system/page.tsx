...
featureMobileTitle={"Advanced Reporting"}
featureMobiledesc={"By bringing all kinds of data like the number of applicants per course/program, demographics of applicants and fee payment status, all are accessible through one dashboard."} Choose={Choose} />
